...
# python ../analysis/dataPreprocess.py ../data/kaggle_norm_competition/en_train.csv 2
...
python preprocess.py -train_src ../data/kaggle_norm_competition/en_train_SRC.txt -train_tgt ../data/kaggle_norm_competition/en_train_DST.txt -classes_tgt ../data/kaggle_norm_competition/en_train_CLASS.txt -valid_src ../data/kaggle_norm_competition/en_val_SRC.txt -valid_tgt ../data/kaggle_norm_competition/en_val_DST.txt -save_data ../data/kaggle_norm_competition/train_kaggle2transformer_2decod.atok.low.pt

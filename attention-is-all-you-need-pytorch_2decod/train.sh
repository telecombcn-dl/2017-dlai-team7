python train.py -data ../data/kaggle_norm_competition/train_kaggle2transformer_2decod.atok.low.pt -save_model weights/trained_1decod_transf_100bdd -save_mode best -proj_share_weight
